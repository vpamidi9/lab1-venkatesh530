...
create_analysis_view -name func_max_scenario -constraint_mode func_max_sdc -delay_corner max_corner -latency_file ${::IMEX::dataVar}/mmmc/views/func_max_scenario/latency.sdc
create_analysis_view -name func_min_scenario -constraint_mode func_min_sdc -delay_corner min_corner -latency_file ${::IMEX::dataVar}/mmmc/views/func_min_scenario/latency.sdc
